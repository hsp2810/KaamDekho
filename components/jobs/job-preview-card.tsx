...
import JobPreviewSkillsTag from "./job-preview-skills-tag";
import JobPreviewEmployerCard from "./job-preview-employer-card";
        ...
        <CardContent className='grid gap-5 py-5'>
          ...
          <div>
            ...
            <p className='text-muted-foreground text-base leading-tight'>
              VDK Group is an industry leading company in the Windows, Doors,
              and Garage Doors sector of the construction industry, prides
              itself on its commitment to selling top-quality products and
              delivering uncompromising installations. With a stellar production
              team in our factory and highly skilled installers in the field,
              we've cultivated a reputation for excellence in our craft. Our
              projects range from custom homes to mid-rise commercial ventures.
              To support our expanding operations, VDK Group Inc. is actively
              seeking a full-time Full Stack Software Developer. We're looking
              for someone versatile and passionate about creating high-quality
              software solutions to enhance and automate our business processes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className='leading-tighter pl-3 text-muted-foreground'>
              <li>
                • Collaborate with fellow developers to translate product
                concepts into tangible releases.
              </li>
              <li>
          ...
          <p className='text-muted-foreground'>
            ...
            contribute to a dynamic team environment while pushing the
            boundaries of technology in the construction industry, we want to
            hear from you. Join us at VDK Group Inc. and be part of our journey
            to redefine excellence in construction technology.
          </p>
        </CardContent>
      </ScrollArea>
    </Card>
